...
import { BsFillPersonPlusFill, BsFillJournalBookmarkFill, BsPersonLinesFill } from 'react-icons/bs';
      ...
      <div className='sidebar'>
        ...
        <div>
              <ul>
                ...
                <li>
                    <Link to="#">
                        <span className="item"><BsFillJournalBookmarkFill /> Add Subjects</span>
                    </Link>
                </li>
                <li>
                    <Link to="#">
